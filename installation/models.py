...
class SiteConstants(models.Model):
    ...
    binge=models.URLField(null=True,blank=True,max_length=250,default=env('BINGE_LINK'))
    favicon=models.ImageField(null=True,blank=True,upload_to='logos/',default="favicon.ico")
